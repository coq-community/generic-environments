...
install:
	for i in $(VOFILES); do \
	 install -d `dirname $(DSTROOT)$(COQLIB)user-contrib/GenericEnvironments/$$i`; \
	 install $$i $(DSTROOT)$(COQLIB)user-contrib/GenericEnvironments/$$i; \
	done

install-doc:
	install -d $(DSTROOT)$(DOCDIR)user-contrib/GenericEnvironments/html
	for i in html/*; do \
	 install $$i $(DSTROOT)$(DOCDIR)user-contrib/GenericEnvironments/$$i;\
	done
